#ifndef LVL1_GL_VERSION_ES_CM_1_0_COMMON_HPP
#define LVL1_GL_VERSION_ES_CM_1_0_COMMON_HPP
...
namespace glue::lvl1
{
	inline namespace common_1_0 
	{
		...
		public:
			...
			function<void(enum_t, const float32_t *)> ClipPlanef = nullptr;
			...
			function<void(float32_t, float32_t, float32_t, float32_t, float32_t, float32_t)> Frustumf = nullptr;
			function<void(enum_t, float32_t *)> GetClipPlanef = nullptr;
			...
			function<void(float32_t, float32_t, float32_t, float32_t, float32_t, float32_t)> Orthof = nullptr;
