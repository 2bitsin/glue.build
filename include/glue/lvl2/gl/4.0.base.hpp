#ifndef LVL2_GL_VERSION_4_0_BASE_HPP
#define LVL2_GL_VERSION_4_0_BASE_HPP

#include "../../lvl1/gl/4.0.base.hpp"
#include "../../math.hpp"

namespace glue::lvl2
{
	inline namespace base_4_0 
	{
		struct api: glue::lvl1::base_4_0::api
		{
