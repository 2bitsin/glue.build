#ifndef LVL2_GL_VERSION_4_2_BASE_HPP
#define LVL2_GL_VERSION_4_2_BASE_HPP

#include "../../lvl1/gl/4.2.base.hpp"
#include "../../math.hpp"

namespace glue::lvl2
{
	inline namespace base_4_2 
	{
		struct api: glue::lvl1::base_4_2::api
		{
