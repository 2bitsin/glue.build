#include <glue/lvl1/gles1/1.0.common.hpp>
	...
	inline namespace common_1_0 
 	{
		void load(api& target, std::function<void*(const char*)> lfn)
		{
			...
			assign(target.ClipPlanef, lfn, impl::str_by_index(5999));
			...
			assign(target.Frustumf, lfn, impl::str_by_index(6558));
			assign(target.GetClipPlanef, lfn, impl::str_by_index(6636));
			...
			assign(target.Orthof, lfn, impl::str_by_index(7614));
