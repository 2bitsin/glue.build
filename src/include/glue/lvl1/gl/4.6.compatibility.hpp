#ifndef LVL1_GL_VERSION_4_6_COMPATIBILITY_HPP
#define LVL1_GL_VERSION_4_6_COMPATIBILITY_HPP
...
namespace glue::lvl1
{
	inline namespace compatibility_4_6 
	{
		...
		public:
			...
			static constexpr auto GL_INDEX = 0x8222;
			static constexpr auto GL_TEXTURE_LUMINANCE_TYPE = 0x8C14;
			static constexpr auto GL_TEXTURE_INTENSITY_TYPE = 0x8C15;
			...
			static constexpr auto GL_DISPLAY_LIST = 0x82E7;
			...
			static constexpr auto GL_NEGATIVE_ONE_TO_ONE = 0x935E;
			static constexpr auto GL_ZERO_TO_ONE = 0x935F;
			static constexpr auto GL_CLIP_ORIGIN = 0x935C;
			static constexpr auto GL_CLIP_DEPTH_MODE = 0x935D;
			static constexpr auto GL_QUERY_WAIT_INVERTED = 0x8E17;
			static constexpr auto GL_QUERY_NO_WAIT_INVERTED = 0x8E18;
			static constexpr auto GL_QUERY_BY_REGION_WAIT_INVERTED = 0x8E19;
			static constexpr auto GL_QUERY_BY_REGION_NO_WAIT_INVERTED = 0x8E1A;
			static constexpr auto GL_MAX_CULL_DISTANCES = 0x82F9;
			static constexpr auto GL_MAX_COMBINED_CLIP_AND_CULL_DISTANCES = 0x82FA;
			static constexpr auto GL_TEXTURE_TARGET = 0x1006;
			static constexpr auto GL_QUERY_TARGET = 0x82EA;
			...
			static constexpr auto GL_CONTEXT_RELEASE_BEHAVIOR = 0x82FB;
			static constexpr auto GL_CONTEXT_RELEASE_BEHAVIOR_FLUSH = 0x82FC;
			static constexpr auto GL_SHADER_BINARY_FORMAT_SPIR_V = 0x9551;
			static constexpr auto GL_SPIR_V_BINARY = 0x9552;
			static constexpr auto GL_PARAMETER_BUFFER = 0x80EE;
			static constexpr auto GL_PARAMETER_BUFFER_BINDING = 0x80EF;
			static constexpr auto GL_CONTEXT_FLAG_NO_ERROR_BIT = 0x00000008;
			static constexpr auto GL_VERTICES_SUBMITTED = 0x82EE;
			static constexpr auto GL_PRIMITIVES_SUBMITTED = 0x82EF;
			static constexpr auto GL_VERTEX_SHADER_INVOCATIONS = 0x82F0;
			static constexpr auto GL_TESS_CONTROL_SHADER_PATCHES = 0x82F1;
			static constexpr auto GL_TESS_EVALUATION_SHADER_INVOCATIONS = 0x82F2;
			static constexpr auto GL_GEOMETRY_SHADER_PRIMITIVES_EMITTED = 0x82F3;
			static constexpr auto GL_FRAGMENT_SHADER_INVOCATIONS = 0x82F4;
			static constexpr auto GL_COMPUTE_SHADER_INVOCATIONS = 0x82F5;
			static constexpr auto GL_CLIPPING_INPUT_PRIMITIVES = 0x82F6;
			static constexpr auto GL_CLIPPING_OUTPUT_PRIMITIVES = 0x82F7;
			static constexpr auto GL_POLYGON_OFFSET_CLAMP = 0x8E1B;
			static constexpr auto GL_SPIR_V_EXTENSIONS = 0x9553;
			static constexpr auto GL_NUM_SPIR_V_EXTENSIONS = 0x9554;
			static constexpr auto GL_TEXTURE_MAX_ANISOTROPY = 0x84FE;
			static constexpr auto GL_MAX_TEXTURE_MAX_ANISOTROPY = 0x84FF;
			static constexpr auto GL_TRANSFORM_FEEDBACK_OVERFLOW = 0x82EC;
			static constexpr auto GL_TRANSFORM_FEEDBACK_STREAM_OVERFLOW = 0x82ED;
			/*	=============
					functions
					============= */
		public:
			...
			function<void(enum_t, std::uint32_t)> VertexP2ui = nullptr;
			function<void(enum_t, const std::uint32_t *)> VertexP2uiv = nullptr;
			function<void(enum_t, std::uint32_t)> VertexP3ui = nullptr;
			function<void(enum_t, const std::uint32_t *)> VertexP3uiv = nullptr;
			function<void(enum_t, std::uint32_t)> VertexP4ui = nullptr;
			function<void(enum_t, const std::uint32_t *)> VertexP4uiv = nullptr;
			function<void(enum_t, std::uint32_t)> TexCoordP1ui = nullptr;
			function<void(enum_t, const std::uint32_t *)> TexCoordP1uiv = nullptr;
			function<void(enum_t, std::uint32_t)> TexCoordP2ui = nullptr;
			function<void(enum_t, const std::uint32_t *)> TexCoordP2uiv = nullptr;
			function<void(enum_t, std::uint32_t)> TexCoordP3ui = nullptr;
			function<void(enum_t, const std::uint32_t *)> TexCoordP3uiv = nullptr;
			function<void(enum_t, std::uint32_t)> TexCoordP4ui = nullptr;
			function<void(enum_t, const std::uint32_t *)> TexCoordP4uiv = nullptr;
			function<void(enum_t, enum_t, std::uint32_t)> MultiTexCoordP1ui = nullptr;
			function<void(enum_t, enum_t, const std::uint32_t *)> MultiTexCoordP1uiv = nullptr;
			function<void(enum_t, enum_t, std::uint32_t)> MultiTexCoordP2ui = nullptr;
			function<void(enum_t, enum_t, const std::uint32_t *)> MultiTexCoordP2uiv = nullptr;
			function<void(enum_t, enum_t, std::uint32_t)> MultiTexCoordP3ui = nullptr;
			function<void(enum_t, enum_t, const std::uint32_t *)> MultiTexCoordP3uiv = nullptr;
			function<void(enum_t, enum_t, std::uint32_t)> MultiTexCoordP4ui = nullptr;
			function<void(enum_t, enum_t, const std::uint32_t *)> MultiTexCoordP4uiv = nullptr;
			function<void(enum_t, std::uint32_t)> NormalP3ui = nullptr;
			function<void(enum_t, const std::uint32_t *)> NormalP3uiv = nullptr;
			function<void(enum_t, std::uint32_t)> ColorP3ui = nullptr;
			function<void(enum_t, const std::uint32_t *)> ColorP3uiv = nullptr;
			function<void(enum_t, std::uint32_t)> ColorP4ui = nullptr;
			function<void(enum_t, const std::uint32_t *)> ColorP4uiv = nullptr;
			function<void(enum_t, std::uint32_t)> SecondaryColorP3ui = nullptr;
			function<void(enum_t, const std::uint32_t *)> SecondaryColorP3uiv = nullptr;
			...
			function<void(enum_t, enum_t)> ClipControl = nullptr;
			function<void(std::int32_t, std::uint32_t *)> CreateTransformFeedbacks = nullptr;
			function<void(std::uint32_t, std::uint32_t, std::uint32_t)> TransformFeedbackBufferBase = nullptr;
			function<void(std::uint32_t, std::uint32_t, std::uint32_t, std::ptrdiff_t, std::ptrdiff_t)> TransformFeedbackBufferRange = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t *)> GetTransformFeedbackiv = nullptr;
			function<void(std::uint32_t, enum_t, std::uint32_t, std::int32_t *)> GetTransformFeedbacki_v = nullptr;
			function<void(std::uint32_t, enum_t, std::uint32_t, std::int64_t *)> GetTransformFeedbacki64_v = nullptr;
			function<void(std::int32_t, std::uint32_t *)> CreateBuffers = nullptr;
			function<void(std::uint32_t, std::ptrdiff_t, const void *, bitfield_t)> NamedBufferStorage = nullptr;
			function<void(std::uint32_t, std::ptrdiff_t, const void *, enum_t)> NamedBufferData = nullptr;
			function<void(std::uint32_t, std::ptrdiff_t, std::ptrdiff_t, const void *)> NamedBufferSubData = nullptr;
			function<void(std::uint32_t, std::uint32_t, std::ptrdiff_t, std::ptrdiff_t, std::ptrdiff_t)> CopyNamedBufferSubData = nullptr;
			function<void(std::uint32_t, enum_t, enum_t, enum_t, const void *)> ClearNamedBufferData = nullptr;
			function<void(std::uint32_t, enum_t, std::ptrdiff_t, std::ptrdiff_t, enum_t, enum_t, const void *)> ClearNamedBufferSubData = nullptr;
			function<void *(std::uint32_t, enum_t)> MapNamedBuffer = nullptr;
			function<void *(std::uint32_t, std::ptrdiff_t, std::ptrdiff_t, bitfield_t)> MapNamedBufferRange = nullptr;
			function<boolean_t(std::uint32_t)> UnmapNamedBuffer = nullptr;
			function<void(std::uint32_t, std::ptrdiff_t, std::ptrdiff_t)> FlushMappedNamedBufferRange = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t *)> GetNamedBufferParameteriv = nullptr;
			function<void(std::uint32_t, enum_t, std::int64_t *)> GetNamedBufferParameteri64v = nullptr;
			function<void(std::uint32_t, enum_t, void **)> GetNamedBufferPointerv = nullptr;
			function<void(std::uint32_t, std::ptrdiff_t, std::ptrdiff_t, void *)> GetNamedBufferSubData = nullptr;
			function<void(std::int32_t, std::uint32_t *)> CreateFramebuffers = nullptr;
			function<void(std::uint32_t, enum_t, enum_t, std::uint32_t)> NamedFramebufferRenderbuffer = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t)> NamedFramebufferParameteri = nullptr;
			function<void(std::uint32_t, enum_t, std::uint32_t, std::int32_t)> NamedFramebufferTexture = nullptr;
			function<void(std::uint32_t, enum_t, std::uint32_t, std::int32_t, std::int32_t)> NamedFramebufferTextureLayer = nullptr;
			function<void(std::uint32_t, enum_t)> NamedFramebufferDrawBuffer = nullptr;
			function<void(std::uint32_t, std::int32_t, const enum_t *)> NamedFramebufferDrawBuffers = nullptr;
			function<void(std::uint32_t, enum_t)> NamedFramebufferReadBuffer = nullptr;
			function<void(std::uint32_t, std::int32_t, const enum_t *)> InvalidateNamedFramebufferData = nullptr;
			function<void(std::uint32_t, std::int32_t, const enum_t *, std::int32_t, std::int32_t, std::int32_t, std::int32_t)> InvalidateNamedFramebufferSubData = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t, const std::int32_t *)> ClearNamedFramebufferiv = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t, const std::uint32_t *)> ClearNamedFramebufferuiv = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t, const float32_t *)> ClearNamedFramebufferfv = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t, float32_t, std::int32_t)> ClearNamedFramebufferfi = nullptr;
			function<void(std::uint32_t, std::uint32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, bitfield_t, enum_t)> BlitNamedFramebuffer = nullptr;
			function<enum_t(std::uint32_t, enum_t)> CheckNamedFramebufferStatus = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t *)> GetNamedFramebufferParameteriv = nullptr;
			function<void(std::uint32_t, enum_t, enum_t, std::int32_t *)> GetNamedFramebufferAttachmentParameteriv = nullptr;
			function<void(std::int32_t, std::uint32_t *)> CreateRenderbuffers = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t, std::int32_t)> NamedRenderbufferStorage = nullptr;
			function<void(std::uint32_t, std::int32_t, enum_t, std::int32_t, std::int32_t)> NamedRenderbufferStorageMultisample = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t *)> GetNamedRenderbufferParameteriv = nullptr;
			function<void(enum_t, std::int32_t, std::uint32_t *)> CreateTextures = nullptr;
			function<void(std::uint32_t, enum_t, std::uint32_t)> TextureBuffer = nullptr;
			function<void(std::uint32_t, enum_t, std::uint32_t, std::ptrdiff_t, std::ptrdiff_t)> TextureBufferRange = nullptr;
			function<void(std::uint32_t, std::int32_t, enum_t, std::int32_t)> TextureStorage1D = nullptr;
			function<void(std::uint32_t, std::int32_t, enum_t, std::int32_t, std::int32_t)> TextureStorage2D = nullptr;
			function<void(std::uint32_t, std::int32_t, enum_t, std::int32_t, std::int32_t, std::int32_t)> TextureStorage3D = nullptr;
			function<void(std::uint32_t, std::int32_t, enum_t, std::int32_t, std::int32_t, boolean_t)> TextureStorage2DMultisample = nullptr;
			function<void(std::uint32_t, std::int32_t, enum_t, std::int32_t, std::int32_t, std::int32_t, boolean_t)> TextureStorage3DMultisample = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, std::int32_t, enum_t, enum_t, const void *)> TextureSubImage1D = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, enum_t, enum_t, const void *)> TextureSubImage2D = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, enum_t, enum_t, const void *)> TextureSubImage3D = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, std::int32_t, enum_t, std::int32_t, const void *)> CompressedTextureSubImage1D = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, enum_t, std::int32_t, const void *)> CompressedTextureSubImage2D = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, enum_t, std::int32_t, const void *)> CompressedTextureSubImage3D = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t)> CopyTextureSubImage1D = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t)> CopyTextureSubImage2D = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t)> CopyTextureSubImage3D = nullptr;
			function<void(std::uint32_t, enum_t, float32_t)> TextureParameterf = nullptr;
			function<void(std::uint32_t, enum_t, const float32_t *)> TextureParameterfv = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t)> TextureParameteri = nullptr;
			function<void(std::uint32_t, enum_t, const std::int32_t *)> TextureParameterIiv = nullptr;
			function<void(std::uint32_t, enum_t, const std::uint32_t *)> TextureParameterIuiv = nullptr;
			function<void(std::uint32_t, enum_t, const std::int32_t *)> TextureParameteriv = nullptr;
			function<void(std::uint32_t)> GenerateTextureMipmap = nullptr;
			function<void(std::uint32_t, std::uint32_t)> BindTextureUnit = nullptr;
			function<void(std::uint32_t, std::int32_t, enum_t, enum_t, std::int32_t, void *)> GetTextureImage = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, void *)> GetCompressedTextureImage = nullptr;
			function<void(std::uint32_t, std::int32_t, enum_t, float32_t *)> GetTextureLevelParameterfv = nullptr;
			function<void(std::uint32_t, std::int32_t, enum_t, std::int32_t *)> GetTextureLevelParameteriv = nullptr;
			function<void(std::uint32_t, enum_t, float32_t *)> GetTextureParameterfv = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t *)> GetTextureParameterIiv = nullptr;
			function<void(std::uint32_t, enum_t, std::uint32_t *)> GetTextureParameterIuiv = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t *)> GetTextureParameteriv = nullptr;
			function<void(std::int32_t, std::uint32_t *)> CreateVertexArrays = nullptr;
			function<void(std::uint32_t, std::uint32_t)> DisableVertexArrayAttrib = nullptr;
			function<void(std::uint32_t, std::uint32_t)> EnableVertexArrayAttrib = nullptr;
			function<void(std::uint32_t, std::uint32_t)> VertexArrayElementBuffer = nullptr;
			function<void(std::uint32_t, std::uint32_t, std::uint32_t, std::ptrdiff_t, std::int32_t)> VertexArrayVertexBuffer = nullptr;
			function<void(std::uint32_t, std::uint32_t, std::int32_t, const std::uint32_t *, const std::ptrdiff_t *, const std::int32_t *)> VertexArrayVertexBuffers = nullptr;
			function<void(std::uint32_t, std::uint32_t, std::uint32_t)> VertexArrayAttribBinding = nullptr;
			function<void(std::uint32_t, std::uint32_t, std::int32_t, enum_t, boolean_t, std::uint32_t)> VertexArrayAttribFormat = nullptr;
			function<void(std::uint32_t, std::uint32_t, std::int32_t, enum_t, std::uint32_t)> VertexArrayAttribIFormat = nullptr;
			function<void(std::uint32_t, std::uint32_t, std::int32_t, enum_t, std::uint32_t)> VertexArrayAttribLFormat = nullptr;
			function<void(std::uint32_t, std::uint32_t, std::uint32_t)> VertexArrayBindingDivisor = nullptr;
			function<void(std::uint32_t, enum_t, std::int32_t *)> GetVertexArrayiv = nullptr;
			function<void(std::uint32_t, std::uint32_t, enum_t, std::int32_t *)> GetVertexArrayIndexediv = nullptr;
			function<void(std::uint32_t, std::uint32_t, enum_t, std::int64_t *)> GetVertexArrayIndexed64iv = nullptr;
			function<void(std::int32_t, std::uint32_t *)> CreateSamplers = nullptr;
			function<void(std::int32_t, std::uint32_t *)> CreateProgramPipelines = nullptr;
			function<void(enum_t, std::int32_t, std::uint32_t *)> CreateQueries = nullptr;
			function<void(std::uint32_t, std::uint32_t, enum_t, std::ptrdiff_t)> GetQueryBufferObjecti64v = nullptr;
			function<void(std::uint32_t, std::uint32_t, enum_t, std::ptrdiff_t)> GetQueryBufferObjectiv = nullptr;
			function<void(std::uint32_t, std::uint32_t, enum_t, std::ptrdiff_t)> GetQueryBufferObjectui64v = nullptr;
			function<void(std::uint32_t, std::uint32_t, enum_t, std::ptrdiff_t)> GetQueryBufferObjectuiv = nullptr;
			function<void(bitfield_t)> MemoryBarrierByRegion = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, enum_t, enum_t, std::int32_t, void *)> GetTextureSubImage = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, std::int32_t, void *)> GetCompressedTextureSubImage = nullptr;
			function<enum_t()> GetGraphicsResetStatus = nullptr;
			function<void(enum_t, std::int32_t, std::int32_t, void *)> GetnCompressedTexImage = nullptr;
			function<void(enum_t, std::int32_t, enum_t, enum_t, std::int32_t, void *)> GetnTexImage = nullptr;
			function<void(std::uint32_t, std::int32_t, std::int32_t, float64_t *)> GetnUniformdv = nullptr;
			...
			function<void(enum_t, enum_t, std::int32_t, float64_t *)> GetnMapdv = nullptr;
			function<void(enum_t, enum_t, std::int32_t, float32_t *)> GetnMapfv = nullptr;
			function<void(enum_t, enum_t, std::int32_t, std::int32_t *)> GetnMapiv = nullptr;
			function<void(enum_t, std::int32_t, float32_t *)> GetnPixelMapfv = nullptr;
			function<void(enum_t, std::int32_t, std::uint32_t *)> GetnPixelMapuiv = nullptr;
			function<void(enum_t, std::int32_t, std::uint16_t *)> GetnPixelMapusv = nullptr;
			function<void(std::int32_t, std::uint8_t *)> GetnPolygonStipple = nullptr;
			function<void(enum_t, enum_t, enum_t, std::int32_t, void *)> GetnColorTable = nullptr;
			function<void(enum_t, enum_t, enum_t, std::int32_t, void *)> GetnConvolutionFilter = nullptr;
			function<void(enum_t, enum_t, enum_t, std::int32_t, void *, std::int32_t, void *, void *)> GetnSeparableFilter = nullptr;
			function<void(enum_t, boolean_t, enum_t, enum_t, std::int32_t, void *)> GetnHistogram = nullptr;
			function<void(enum_t, boolean_t, enum_t, enum_t, std::int32_t, void *)> GetnMinmax = nullptr;
			function<void()> TextureBarrier = nullptr;
			function<void(std::uint32_t, const char *, std::uint32_t, const std::uint32_t *, const std::uint32_t *)> SpecializeShader = nullptr;
			function<void(enum_t, const void *, std::ptrdiff_t, std::int32_t, std::int32_t)> MultiDrawArraysIndirectCount = nullptr;
			function<void(enum_t, enum_t, const void *, std::ptrdiff_t, std::int32_t, std::int32_t)> MultiDrawElementsIndirectCount = nullptr;
			function<void(float32_t, float32_t, float32_t)> PolygonOffsetClamp = nullptr;
		public:
